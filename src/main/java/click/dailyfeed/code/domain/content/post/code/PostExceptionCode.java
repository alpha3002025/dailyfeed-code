package click.dailyfeed.code.domain.content.post.code;
...
public enum PostExceptionCode {
    ...
    POST_LIKE_ALREADY_EXISTS("이미 좋아요 하셨습니다", "POST_LIKE_ALREADY_EXISTS", 400),
    POST_LIKE_CANCEL_ALREADY_COMMITTED("더 이상 좋아요를 취소할 수 없습니다.", "POST_LIKE_CANCEL_ALREADY_COMMITTED", 400),
